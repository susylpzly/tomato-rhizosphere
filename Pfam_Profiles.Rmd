...
df_few0_funct <- df_counts[filter_fun(df_counts,df_info$Treatment, 0.18, 0.85),]
...
df_few0_712_GUS <- df_712_GUS[filter_fun(df_712_GUS,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(1,5)]],0.18, 0.85),]
...
df_few0_722_GUS <- df_722_GUS[filter_fun(df_722_GUS,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(2,5)]],0.18, 0.85),]

#722-MMA
#df_722_MMA <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(2,6)]]
#df_few0_722_MMA <- df_722_MMA[filter_fun(df_722_MMA,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(2,6)]],0.18, 0.85),]

#722_EP
#df_722_EP <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(2,4)]]
#df_few0_722_EP <- df_722_EP[filter_fun(df_722_EP,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(2,4)]],0.18, 0.85),]

#CCD8-GUS
df_CCD8_GUS <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(3,5)]]
df_few0_CCD8_GUS <- df_CCD8_GUS[filter_fun(df_CCD8_GUS,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(3,5)]],0.18, 0.85),]

#CCD8-MMA
#df_CCD8_MMA <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(3,6)]]
#df_few0_CCD8_MMA <- df_CCD8_MMA[filter_fun(df_CCD8_MMA,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(3,6)]],0.18, 0.85),]

#CCD8_EP
#df_CCD8_EP <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(3,4)]]
#df_few0_CCD8_EP <- df_CCD8_EP[filter_fun(df_CCD8_EP,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(3,4)]],0.18, 0.85),]

#2 Controls 
#GUS-MMA 
df_GUS_MMA <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(5,6)]]
df_few0_GUS_MMA <- df_GUS_MMA[filter_fun(df_GUS_MMA,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(5,6)]],0.18, 0.85),]


#all but EP
df_all_plant <- df_counts[,df_info$Treatment %in% unique(df_info$Treatment)[c(1,2,3,5,6)]]
df_few0_plant <- df_all_plant[filter_fun(df_all_plant,df_info$Treatment[df_info$Treatment %in% unique(df_info$Treatment)[c(1,2,3,5,6)]],0.18, 0.85),]
...
autoplot(few0_funct_pca_log, data=t(log(df_few0_funct_psc)), colour = rainbow(6)[as.numeric(as.factor(df_info$Treatment))])
...
autoplot(few0_funct_pca_hellinger, data=t(df_few0_funct_hellinger), colour = rainbow(6)[as.numeric(as.factor(df_info$Treatment))])
...
autoplot(few0_plant_pca_log, data=t(df_few0_plant_psc), colour = rainbow(6)[as.numeric(as.factor(df_info_plant$Treatment))])
...
autoplot(few0_plant_pca_hellinger, data=t(df_few0_plant_hellinger), colour = rainbow(6)[as.numeric(as.factor(df_info_plant$Treatment))])
...
autoplot(few0_plant_pca_sum, data=t(df_few0_plant_sum), colour = rainbow(6)[as.numeric(as.factor(df_info_plant$Treatment))], label = TRUE)
```
...
#library size
#logistic
prepro <- feature_table_pre_process(feature_table = df_few0_funct[rowSums(df_few0_funct[,df_info$Treatment %in% c("GUS","712")])>0,df_info$Treatment %in% c("GUS","712")], 
